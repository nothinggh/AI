...
WEIGHT_DATA = {
    "PIPE(6M)": {"8A": 3.0, "10A": 4.0, "15A": 5.1, "20A": 6.8, "25A": 10.1, "32A": 13.7, "40A": 16.0, "50A": 21.5, "65A": 30.5, "80A": 36.2, "100A": 51.0},
    "FLANGE": {"15A": 0.8, "20A": 1.0, "25A": 1.4, "32A": 2.0, "40A": 2.2, "50A": 2.8, "65A": 3.8, "80A": 4.5, "100A": 5.6},
    "COUPLING": {"15A": 0.15, "20A": 0.2, "25A": 0.3, "32A": 0.45, "40A": 0.55, "50A": 0.8, "65A": 1.2, "80A": 1.6, "100A": 2.3},
    "BOLT": {"15A": 0.1, "20A": 0.1, "25A": 0.12, "32A": 0.15, "40A": 0.15, "50A": 0.2, "65A": 0.2, "80A": 0.25, "100A": 0.3},
    "NUT": {"15A": 0.05, "20A": 0.05, "25A": 0.06, "32A": 0.08, "40A": 0.08, "50A": 0.1, "65A": 0.1, "80A": 0.12, "100A": 0.15},
    "GASKET": {"15A": 0.03, "20A": 0.04, "25A": 0.05, "32A": 0.06, "40A": 0.07, "50A": 0.09, "65A": 0.12, "80A": 0.15, "100A": 0.2},
    "ELBOW": {"15A": 0.2, "20A": 0.3, "25A": 0.5, "32A": 0.8, "40A": 1.0, "50A": 1.6, "65A": 2.6, "80A": 3.7, "100A": 6.5},
    "TEE": {"15A": 0.3, "20A": 0.4, "25A": 0.7, "32A": 1.1, "40A": 1.4, "50A": 2.1, "65A": 3.5, "80A": 4.8, "100A": 8.2}
}

PRICE_DATA = {
    "PIPE(6M)": {"8A": 12000, "10A": 15000, "15A": 18000, "20A": 23000, "25A": 31000, "32A": 42000, "40A": 48000, "50A": 63000, "65A": 88000, "80A": 105000, "100A": 145000},
    "FLANGE": {"15A": 4500, "20A": 5500, "25A": 7000, "32A": 9000, "40A": 11000, "50A": 14000, "65A": 19000, "80A": 23000, "100A": 31000},
    "COUPLING": {"15A": 1200, "20A": 1500, "25A": 2000, "32A": 2800, "40A": 3500, "50A": 4800, "65A": 7000, "80A": 9500, "100A": 13000},
    "BOLT": {"15A": 500, "20A": 500, "25A": 600, "32A": 700, "40A": 700, "50A": 900, "65A": 900, "80A": 1200, "100A": 1500},
    "NUT": {"15A": 300, "20A": 300, "25A": 350, "32A": 400, "40A": 400, "50A": 500, "65A": 500, "80A": 700, "100A": 900},
    "GASKET": {"15A": 800, "20A": 1000, "25A": 1200, "32A": 1500, "40A": 1800, "50A": 2300, "65A": 3000, "80A": 3800, "100A": 5000},
    "ELBOW": {"15A": 1500, "20A": 2000, "25A": 2800, "32A": 4000, "40A": 5200, "50A": 7500, "65A": 12000, "80A": 16000, "100A": 25000},
    "TEE": {"15A": 2200, "20A": 2900, "25A": 4000, "32A": 5800, "40A": 7500, "50A": 10500, "65A": 17000, "80A": 23000, "100A": 36000}
}
...
if tab_choice == "1. 자재 주문 등록":
    ...
    if st.button("등록"):
        if material in ["STEEL", "SUS"] and size in ["8A", "10A"]:
            st.error("STEEL 및 SUS 재질은 8A, 10A SIZE 주문이 불가능합니다.")
        elif material == "COPPER" and size not in ["8A", "10A"]:
            st.error("COPPER 재질은 8A, 10A SIZE만 주문이 가능합니다.")
        else:
            conn = sqlite3.connect(DB_PATH)
            cursor = conn.cursor()
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """, (user_id, ship_no, item_type, material, size, quantity, total_weight, total_price, order_date, request_note))
            conn.commit()
            conn.close()
            st.success("자재 주문 등록이 완료되었습니다.")
    ...
    if not df.empty:
        ...
        edited_df = st.data_editor(
            ...
            column_config={
                ...
                "item_type": st.column_config.SelectboxColumn("자재 종류", options=ITEMS),
            ...
            if st.button("선택 항목 수정 저장"):
                ...
                for _, row in edited_df.iterrows():
                    ...
                    if mat in ["STEEL", "SUS"] and sz in ["8A", "10A"]:
                        st.error(f"ID {row['id']}: STEEL 및 SUS 재질은 8A, 10A SIZE가 불가능합니다.")
                        continue
                    if mat == "COPPER" and sz not in ["8A", "10A"]:
                        st.error(f"ID {row['id']}: COPPER 재질은 8A, 10A SIZE만 가능합니다.")
                        continue

                    cursor.execute("""
                        UPDATE BOM SET
                        user_id=?, ship_no=?, item_type=?, material=?, size=?, quantity=?, weight=?, price=?, order_date=?, request_note=?
                        WHERE id=?
                    """, (
        ...
        with col_act2:
            if st.button("선택 항목 삭제"):
                ...
                if selected_ids:
                    conn = sqlite3.connect(DB_PATH)
                    cursor = conn.cursor()
                    cursor.executemany("DELETE FROM BOM WHERE id=?", [(i,) for i in selected_ids])
                    conn.commit()
                    conn.close()
